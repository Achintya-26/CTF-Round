  ...
  const io = new Server(server, {
    cors: {
      origin: ["http://localhost:5173", "https://ctf-round-client.vercel.app","https://ctf-round.vercel.app"], // Allow frontend
  ...
  // Middleware
  app.use(cors({ origin: ["http://localhost:5173", "https://ctf-round-client.vercel.app","https://ctf-round.vercel.app"], credentials: true }));
